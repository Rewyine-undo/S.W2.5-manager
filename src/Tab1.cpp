...
Tab1Panel::Tab1Panel(wxWindow* parent)
    ...
    // JSONファイル読み込み用のUI
    wxStaticText* instruction = new wxStaticText(this, wxID_ANY, "JSONファイルを読み込み、データを表示します。");
    ...
    nameSizer->Add(new wxStaticText(this, wxID_ANY, "名前: "), 0, wxALIGN_CENTER_VERTICAL | wxRIGHT, 3);
    ...
    speciesSizer->Add(new wxStaticText(this, wxID_ANY, "種族: "), 0, wxALIGN_CENTER_VERTICAL | wxRIGHT, 3);
    ...
    speciesSizer->Add(new wxStaticText(this, wxID_ANY, "年齢: "), 0, wxALIGN_CENTER_VERTICAL | wxRIGHT, 3);
    ...
    speciesSizer->Add(new wxStaticText(this, wxID_ANY, "性別: "), 0, wxALIGN_CENTER_VERTICAL | wxRIGHT, 3);
    ...
    speciesSizer->Add(new wxStaticText(this, wxID_ANY, "穢れ: "), 0, wxALIGN_CENTER_VERTICAL | wxRIGHT, 3);
    ...
    spfeatureSizer->Add(new wxStaticText(this, wxID_ANY, "種族特徴: "), 0, wxALIGN_CENTER_VERTICAL | wxRIGHT, 3);
    ...
    faithSizer->Add(new wxStaticText(this, wxID_ANY, "生まれ: "), 0, wxALIGN_CENTER_VERTICAL | wxRIGHT, 3);
    ...
    faithSizer->Add(new wxStaticText(this, wxID_ANY, "信仰: "), 0, wxALIGN_CENTER_VERTICAL | wxRIGHT, 3);
    ...
    faithSizer->Add(new wxStaticText(this, wxID_ANY, "ランク: "), 0, wxALIGN_CENTER_VERTICAL | wxRIGHT, 3);
    rankTextBox = new wxTextCtrl(this, wxID_ANY, "ー", wxDefaultPosition, wxSize(80, -1));
    ...
    wxStaticText* abi = new wxStaticText(this, wxID_ANY, "---能力値---");
    sizer->Add(abi, 0, wxALL, 10);
    wxStaticText* comment = new wxStaticText(this, wxID_ANY, "命中力などは技能、武具の中で最大値を参照");
    ...
    const wxString bornLabels[3] = { "(技", "(体", "(心" };
    for (int i = 0; i < 3; ++i) {
        // ラベルを追加
    ...
    for (int i = 0; i < 6; ++i) {
        // ラベルを追加
        wxStaticText* label = new wxStaticText(this, wxID_ANY, "+成長)");
    ...
    const wxString attributeLabels[6] = { "=(器用度", "=(敏捷度", "=(筋力", "=(生命力", "=(知力", "=(精神力" };
    for (int i = 0; i < 6; ++i) {
        // ラベルを追加
    ...
    for (int i = 0; i < 6; ++i) {
        // ラベルを追加
        wxStaticText* label = new wxStaticText(this, wxID_ANY, "+増強)");
    ...
    const wxString bonusLabels[6] = { "/6→器用度B", "/6→敏捷度B", "/6→筋力B", "/6→生命力B", "/6→知力B", "/6→精神力B" };
    for (int i = 0; i < 6; ++i) {
        // ラベルを追加
    ...
    const wxString hpLabels[4] = { "HP", "MP", "生命抵抗力", "精神抵抗力"};
    for (int i = 0; i < 4; ++i) {
        // ラベルを追加
    ...
    const wxString hitLabels[4] = {"命中力", "追加D", "回避力", "防護点" };
    for (int i = 0; i < 4; ++i) {
        // ラベルを追加
    ...
    wxStaticText* packlabel = new wxStaticText(this, wxID_ANY, "判定パッケージ: ");
    packSizer->Add(packlabel, 0, wxALIGN_LEFT | wxBOTTOM, 5);  // ラベルの下にスペースを追加
    const wxString packLabels[7] = {"技巧" , "運動" , "観察" , "知識", "魔物知識", "先制力", "魔力"};
    for (int i = 0; i < 7; ++i) {
        // ラベルを追加
    ...
    moveSizer->Add(new wxStaticText(this, wxID_ANY, "移動力: "), 0, wxALIGN_CENTER_VERTICAL | wxRIGHT, 5);
    ...
    moveSizer->Add(new wxStaticText(this, wxID_ANY, "*3= 全力移動: "), 0, wxALIGN_CENTER_VERTICAL | wxRIGHT, 5);
    ...
    moveSizer->Add(new wxStaticText(this, wxID_ANY, "m"), 0, wxALIGN_CENTER_VERTICAL | wxRIGHT, 10);
    moveSizer->Add(new wxStaticText(this, wxID_ANY, "制限移動: "), 0, wxALIGN_CENTER_VERTICAL | wxRIGHT, 5);
    ...
    wxStaticText* tec = new wxStaticText(this, wxID_ANY, "---技能・特技---");
    ...
    // ラベルを追加
    wxStaticText* techlabel = new wxStaticText(this, wxID_ANY, "技能 ");
    ...
    // ラベルを追加
    wxStaticText* tablelabel = new wxStaticText(this, wxID_ANY, "テーブル ");
    ...
    // ラベルを追加
    wxStaticText* techlevellabel = new wxStaticText(this, wxID_ANY, "レベル ");
    ...
    // ラベルを追加
    wxStaticText* explabel = new wxStaticText(this, wxID_ANY, "使用経験値 ");
    ...
    allexpSizer->Add(new wxStaticText(this, wxID_ANY, "取得経験値: "), 0, wxALIGN_CENTER_VERTICAL);
    ...
    allexpSizer->Add(new wxStaticText(this, wxID_ANY, "合計使用経験値: "), 0, wxALIGN_CENTER_VERTICAL );
    ...
    levelSizer->Add(new wxStaticText(this, wxID_ANY, "冒険者レベル: "), 0, wxALIGN_CENTER_VERTICAL );
    ...
    warningText = new wxStaticText(this, wxID_ANY, "取得経験値を超過しています！", wxPoint(10, 10));
    ...
    // ラベルを追加
    wxStaticText * talentlabel = new wxStaticText(this, wxID_ANY, "戦闘特技");
    talentSizer->Add(talentlabel, 0, wxALIGN_CENTER | wxBOTTOM, 2);  // ラベルの下にスペースを追加
    for (int i = 0; i < 8; ++i) {
        wxString talentText = wxString::Format("%d: ", 2 * i + 1); // 数値を文字列に変換
        // テキストボックスを追加
    ...
    // ラベルを追加
    wxStaticText* abstlabel = new wxStaticText(this, wxID_ANY, "効果概要");
    ...
    // ラベルを追加
    wxStaticText* freetalentlabel = new wxStaticText(this, wxID_ANY, "自動取得など");
    ...
    // ラベルを追加
    wxStaticText* freeabstlabel = new wxStaticText(this, wxID_ANY, "効果概要");
    ...
    // ラベルを追加
    wxStaticText* magictalentlabel = new wxStaticText(this, wxID_ANY, "よく使う魔法など");
    ...
    // ラベルを追加
    wxStaticText* magicabstlabel = new wxStaticText(this, wxID_ANY, "MP, 効果概要");
    ...
    // ラベルを追加
    wxStaticText* battlelabel = new wxStaticText(this, wxID_ANY, "戦闘関連メモ");
    wxStaticText* battlelabel2 = new wxStaticText(this, wxID_ANY, "(受けた効果など)");
    ...
    // ラベルを追加
    wxStaticText* langlabel = new wxStaticText(this, wxID_ANY, "言語");
    langSizer->Add(langlabel, 0, wxALIGN_CENTER | wxBOTTOM, 5);  // ラベルの下にスペースを追加
    const wxString langtext[10] = { "交易共通語", "汎用蛮族語", "地方語(ブルライト)", "種族言語( )", "魔法文明語", "魔動機文明語", "妖精語", "神紀文明語", "魔神語", ""};
    for (int i = 0; i < 10; ++i) {
        // テキストボックスを追加
    ...
    // ラベルを追加
    wxStaticText* speaklabel = new wxStaticText(this, wxID_ANY, "会話");
    ...
    // ラベルを追加
    wxStaticText* readlabel = new wxStaticText(this, wxID_ANY, "読文");
    ...
    // ラベルを追加
    wxStaticText* otherlabel = new wxStaticText(this, wxID_ANY, "経歴、その他メモなど");
    ...
    wxStaticText* item = new wxStaticText(this, wxID_ANY, "---武具・所持品---");
    ...
    // ラベルを追加
    wxStaticText* weaponnamelabel = new wxStaticText(this, wxID_ANY, "武器");
    ...
    // ラベルを追加
    wxStaticText* weaponuselabel = new wxStaticText(this, wxID_ANY, "用法");
    ...
    // ラベルを追加
    wxStaticText* weaponstrlabel = new wxStaticText(this, wxID_ANY, "必筋");
    ...
    // ラベルを追加
    wxStaticText* weaponhitlabel = new wxStaticText(this, wxID_ANY, "命中力");
    ...
    // ラベルを追加
    wxStaticText* weapondmlabel = new wxStaticText(this, wxID_ANY, "威力");
    ...
    // ラベルを追加
    wxStaticText* weaponcritlabel = new wxStaticText(this, wxID_ANY, "C値");
    ...
    // ラベルを追加
    wxStaticText* weaponaddlabel = new wxStaticText(this, wxID_ANY, "追加D");
    ...
    // ラベルを追加
    wxStaticText* weaponotherlabel = new wxStaticText(this, wxID_ANY, "備考");
    ...
    // ラベルを追加
    wxStaticText* armornamelabel = new wxStaticText(this, wxID_ANY, "防具");
    armornameSizer->Add(armornamelabel, 0, wxALIGN_CENTER | wxBOTTOM, 5);  // ラベルの下にスペースを追加
    const wxString armortext[3] = { "鎧", "盾", "その他" };
    for (int i = 0; i < 3; ++i) {
        // テキストボックスを追加
    ...
    // ラベルを追加
    wxStaticText* armorstrlabel = new wxStaticText(this, wxID_ANY, "必筋");
    ...
    // ラベルを追加
    wxStaticText* armorevadelabel = new wxStaticText(this, wxID_ANY, "回避修正");
    ...
    // ラベルを追加
    wxStaticText* armorblocklabel = new wxStaticText(this, wxID_ANY, "防護点");
    ...
    // ラベルを追加
    wxStaticText* armorotherlabel = new wxStaticText(this, wxID_ANY, "備考");
    ...
    poketSizer->Add(new wxStaticText(this, wxID_ANY, "所持金: "), 0, wxALIGN_CENTER_VERTICAL | wxRIGHT, 5);
    ...
    debtSizer->Add(new wxStaticText(this, wxID_ANY, "預金/借金: "), 0, wxALIGN_CENTER_VERTICAL | wxRIGHT, 5);
    ...
    glorySizer->Add(new wxStaticText(this, wxID_ANY, "名誉点: "), 0, wxALIGN_CENTER_VERTICAL | wxRIGHT, 5);
    ...
    glorySizer->Add(new wxStaticText(this, wxID_ANY, "点"), 0, wxALIGN_CENTER_VERTICAL | wxLEFT, 0);
    ...
    // ラベルを追加
    wxStaticText* aceslabel = new wxStaticText(this, wxID_ANY, "各部位の装飾品");
    acesSizer1->Add(aceslabel, 0, wxALIGN_CENTER | wxBOTTOM, 5);  // ラベルの下にスペースを追加
    const wxString acesLabels[12] = { "頭", "顔", "耳", "首", "背中", "右手", "左手", "腰", "足", "その他", "その他2", "その他3" };
    ...
    // ラベルを追加
    wxStaticText* aceslabel2 = new wxStaticText(this, wxID_ANY, "効果概要");
    ...
    // ラベルを追加
    wxStaticText* baglabel = new wxStaticText(this, wxID_ANY, "所持アイテムなど");
...
void Tab1Panel::Updatehp(wxCommandEvent& event) {
    ...
    for (int i = 0; i < 6; ++i) {
        ...
        if (className.empty()) {
        ...
        else if (className == "ファイター" || className == "グラップラー" || className == "フェンサー") {
            ...
            for (int i = 0; i < 8; ++i) { // 回避の判定
                ...
                if (talentName.find("射手の体術") != std::string::npos){
        ...
        else if (className == "ソーサラー" || className == "コンジャラー" || className == "プリースト" || className == "マギテック" || className == "フェアリーテイマー") {
            magically[i] = techlevelSpinCtrl[i]->GetValue();
        }// 魔法使い系技能

        else if (className == "スカウト" || className == "レンジャー") {
            tech = techlevelSpinCtrl[i]->GetValue() + bonus[0]; // 技巧
            mov = techlevelSpinCtrl[i]->GetValue() + bonus[1]; // 運動、先制力
        }// 先制技能

        else if (className == "セージ" || className == "ライダー") {
			sage = techlevelSpinCtrl[i]->GetValue() + bonus[4]; //観察、知識、魔物知識
        }// 魔物知識技能

        //else if (className == "エンハンサー" && !enhancerAdded) {
        //    // 全体をまとめる一時的なラッパーsizer
        //    wxBoxSizer* wrapperSizer = new wxBoxSizer(wxVERTICAL);
        //    newSizer->Add(new wxStaticText(this, wxID_ANY, "習得練技"), 0);

        //    for (int j = 0; j < 8; ++j) {
        //        wxString otherskillText1 = wxString::Format("%d: ", j + 1); // 数値を文字列に変換
        //        //テキストボックスを追加
        ...
        //     }
        //    for (int j = 0; j < 7; ++j) {
        //        wxString otherskillText2 = wxString::Format("%d: ", j + 9); // 数値を文字列に変換
        //        //テキストボックスを追加
        ...
        //else if (className == "バード") {
        //    placeholderSizer->Add(new wxStaticText(this, wxID_ANY, "習得呪歌・終律"), 0, wxALL, 5);
        //    for (int j = 0; j < 8; ++j) {
        //        wxString otherskillText = wxString::Format("%d: ", j + 1); // 数値を文字列に変換
        //        //テキストボックスを追加
        ...
        //    }
        //    for (int j = 0; j < 7; ++j) {
        //        wxString otherskillText = wxString::Format("%d: ", j + 9); // 数値を文字列に変換
        //        //テキストボックスを追加
        //        otherskillTextBoxes[j] = new wxTextCtrl(this, wxID_ANY, otherskillText, wxDefaultPosition, wxSize(120, -1));
        ...
        //else if (className == "ライダー") {
        //    // 全体をまとめる一時的なラッパーsizer
        //    wxBoxSizer* wrapperSizer = new wxBoxSizer(wxVERTICAL);
        //    wrapperSizer->Add(new wxStaticText(this, wxID_ANY, "習得騎芸"), 0);
        ...
        //else if (className == "アルケミスト") {
        //    placeholderSizer->Add(new wxStaticText(this, wxID_ANY, "習得賦術"), 0, wxALL, 5);
        //    for (int j = 0; j < 8; ++j) {
        //        wxString otherskillText = wxString::Format("%d: ", j + 1); // 数値を文字列に変換
        //        //テキストボックスを追加
        //        otherskillTextBoxes[j] = new wxTextCtrl(this, wxID_ANY, otherskillText, wxDefaultPosition, wxSize(120, -1));
    ...
    for (int i = 0; i < 8; ++i) { // 常時特技による能力値の修正
        ...
        else if (talentName.find("足さばき") != std::string::npos) {
            restmoveTextBox->SetValue(wxString::Format("10")); // 足さばきがある場合
        }
        else if (talentName.find("回避行動Ⅰ") != std::string::npos) {
            evade += 1; // 回避行動Ⅰがある場合
        }
        else if (talentName.find("回避行動Ⅱ") != std::string::npos) {
            evade += 2; // 回避行動Ⅱがある場合 
        }
        else if (talentName.find("頑強") != std::string::npos) {
            vital += 15; // 頑強がある場合
        }
        else if (talentName.find("超頑強") != std::string::npos) {
            vital += 15; // 超頑強がある場合
        }
        else if (talentName.find("武器習熟A") != std::string::npos) {
            weapondamage += 1; // 武器習熟Aがある場合
        }
        else if (talentName.find("武器習熟S") != std::string::npos) {
            weapondamage += 2; // 武器習熟Sがある場合
        }
        else if (talentName.find("防具習熟A") != std::string::npos) {
            tarmor += 1; // 防具習熟Aがある場合
        }
        else if (talentName.find("防具習熟S") != std::string::npos) {
            tarmor += 2; // 防具習熟Sがある場合
        }
        else if (talentName.find("魔力強化Ⅰ") != std::string::npos) {
            bonus[4] += 1; // 魔力強化Ⅰがある場合
        }
        else if (talentName.find("魔力強化Ⅱ") != std::string::npos) {
            bonus[4] += 2; // 魔力強化Ⅱがある場合
        }
        else if (talentName.find("命中強化Ⅰ") != std::string::npos) {
            weaponhit += 1; // 命中強化Ⅰがある場合
        }
        else if (talentName.find("命中強化Ⅱ") != std::string::npos) {
            weaponhit += 2; // 命中強化Ⅱがある場合
        }
        else if (talentName.find("キャパシティ") != std::string::npos) {
    ...
    if (freetalentName.find("タフネス") != std::string::npos) {
		vital += 15; // タフネスがある場合
    }

    // 冒険者レベルで計算できる項目
    hpTextBoxes[0]->SetValue(wxString::Format("%ld", (3 * lv + vital))); // Hp
    hpTextBoxes[2]->SetValue(wxString::Format("%ld", (lv + bonus[3]))); // 生命抵抗力
    hpTextBoxes[3]->SetValue(wxString::Format("%ld", (lv + bonus[5]))); // 精神抵抗力
    ...
    hitSpinCtrl[0]->SetValue(wxString::Format("%ld", (hit + weaponhit)));// 命中力
    hitSpinCtrl[1]->SetValue(wxString::Format("%ld", (damage + weapondamage)));// 追加D
    hitSpinCtrl[2]->SetValue(wxString::Format("%ld", (evade + tarmorevade)));// 回避力
	hitSpinCtrl[3]->SetValue(wxString::Format("%ld", (tarmor)));// 防護点

    packSpinCtrl[0]->SetValue(wxString::Format("%ld", (tech)));// 技巧
    packSpinCtrl[1]->SetValue(wxString::Format("%ld", (mov)));// 運動
    packSpinCtrl[2]->SetValue(wxString::Format("%ld", (sage)));// 観察
    packSpinCtrl[3]->SetValue(wxString::Format("%ld", (sage)));// 知識
    packSpinCtrl[4]->SetValue(wxString::Format("%ld", (sage)));// 魔物知識
    packSpinCtrl[5]->SetValue(wxString::Format("%ld", (mov)));// 先制力
	packSpinCtrl[6]->SetValue(wxString::Format("%ld", (mlv + bonus[4])));// 魔力
    
    
    moveTextBox->SetValue(wxString::Format("%ld", aglity)); // 移動力
    fullmoveTextBox->SetValue(wxString::Format("%ld", 3*aglity)); // 全力移動力
}
